...
void calculateCoefficients(double sampleRate, double cutoffFrequency, double& b0, double& b1, double& a1) {
...
void processHp(std::vector<float>& buffer, double sampleRate, double cutoffFrequency, double& prevInput, double& prevOutput) {
    double b0, b1, a1;
    calculateCoefficients(sampleRate, cutoffFrequency, b0, b1, a1);
